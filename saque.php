...
<body>
    <div class="container-fluid">
        <div class="row">
            ...
            ?>
            <form action="./api/sacar.php" method="POST" class="row col-md-9 col-xl-10 py-3 d-flex justify-content-center align-items-center containerCards vh-100">
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-5 col-xl-4 d-flex align-items-stretch">
                    <div class="card" style="height: 250px;">
                        <div class="card-body text-justify">
                            <h2 class="card-title">Área de Saque</h2>
                            <hr>
                            <strong>Valor do saque: </strong><input type="text" name="valorSaque" placeholder="digite o valor a ser sacado" class="card-input">
                        </div>
                    </div>
                </div>
                <div class="col-12 mt-3 text-center">
                    <!-- <button class="btn btn-primary" type="button" onclick="habilitarInputs()"><strong>Editar</strong></button> -->
                    <button class="btn btn-primary" type="submit"><strong>Sacar</strong></button>
                </div>
            </form>
        </div>
    </div>
